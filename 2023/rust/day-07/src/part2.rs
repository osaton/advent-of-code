...
impl Hand {
    ...
    fn get_ranking(&self) -> Ranking {
        ...
        let (mut most_count, _) = collection
            .next()
            .or(Some((0, &Card::Joker)))
        ...
        match (most_count, second_count) {
            ...
            _ => {
                dbg!(most_count, second_count, self);
                unreachable!()
            }
        }
    }
...
QQQJA 483";
    ...
    fn test_hand_get_ranking() -> miette::Result<()> {
        ...
        let hand = Hand::new("32J3K", 765);
        assert_eq!(Ranking::ThreeOfAKind, hand.get_ranking());
        let hand = Hand::new("AAAAJ", 765);
        assert_eq!(Ranking::FiveOfAKind, hand.get_ranking());
        let hand = Hand::new("22J33", 765);
        assert_eq!(Ranking::FullHouse, hand.get_ranking());
        let hand = Hand::new("J3456", 765);
        assert_eq!(Ranking::OnePair, hand.get_ranking());
        let hand = Hand::new("43455", 765);
        assert_eq!(Ranking::TwoPair, hand.get_ranking());
        let hand = Hand::new("JJJJJ", 765);
        assert_eq!(Ranking::FiveOfAKind, hand.get_ranking());
        Ok(())
    }
